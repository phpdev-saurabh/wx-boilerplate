...
class Class_Wx_Boilerplate {
	...
	public function __construct() {
		if ( defined( 'WX_BOILERPLATE_VERSION' ) ) {
			$this->version = WX_BOILERPLATE_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'wx-boilerplate';
	...
	private function load_dependencies() {
		...
		$this->loader = new Wx_Boilerplate_Loader();
	...
	private function set_locale() {
		...
		$plugin_i18n = new Wx_Boilerplate_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Wx_Boilerplate_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Wx_Boilerplate_Public( $this->get_plugin_name(), $this->get_version() );
